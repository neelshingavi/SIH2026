...
export class HieController {
  ...
  @Post('export')
  @Roles(Role.ASHA, Role.ANM, Role.MEDICAL_OFFICER, Role.SPECIALIST)
  ...
  @Roles(Role.ASHA, Role.ANM, Role.MEDICAL_OFFICER, Role.SPECIALIST, Role.SYSTEM_ADMIN)
  ...
  @Get('metrics')
  @Roles(Role.MEDICAL_OFFICER, Role.SYSTEM_ADMIN, Role.DISTRICT_OFFICER)
  async getMetrics() {
  ...
  @Get('dlq')
  @Roles(Role.SYSTEM_ADMIN, Role.DISTRICT_OFFICER)
  ...
  @Post('import')
  @Roles(Role.MEDICAL_OFFICER, Role.SPECIALIST, Role.SYSTEM_ADMIN)
